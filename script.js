...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleUserInteraction(imageUrl, imageTitle, interactionType, content = '') {
        try {
    ...
    function setupInteractionButtons() {
        ...
        if (likeBtn) {
            likeBtn.addEventListener('click', async () => {
                ...
                if (currentImage) {
                    const result = await handleUserInteraction(
                        currentImage.url, 
                        currentImage.title, 
                        'like'
                    );
                    if (result) {
                        likeBtn.classList.toggle('liked', result.status === 'added');
                    }
                }
            });
        }
        ...
        if (favoriteBtn) {
            favoriteBtn.addEventListener('click', async () => {
                ...
                if (currentImage) {
                    ...
                    if (result) {
                        favoriteBtn.classList.toggle('liked', result.status === 'added');
                    }
                }
            });
        }
...
// ...existing code...
    ...
    function init() {
        ...
        setupInteractionButtons(); // Call the new function here
    }
